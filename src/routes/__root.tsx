  ...
  head: () => ({
    meta: [
      ...
      { title: "Venue Vue — POS & Event Management" },
      {
        name: "description",
        content:
          "Offline-first point of sale and event management for venues.",
      },
      { name: "author", content: "Venue Vue" },
    ...
    links: [
      ...
      // Fonts are self-hosted from /public/fonts via @font-face in styles.css,
      // so the app renders with no network access.
      {
        rel: "preload",
      ...
      {
        rel: "preload",
        href: "/fonts/SpaceGrotesk-600-latin.woff2",
        as: "font",
        type: "font/woff2",
        crossOrigin: "anonymous",
      },
